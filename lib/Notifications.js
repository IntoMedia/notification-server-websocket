module.exports = class Notifications {
	...
	group(g_type,g_name,data,message){
		var type = message.type;
		delete message.type;
		...
		*/
		...
		this.createPush(message.type,message.title,message.msg,message.url,{method:'group',type:g_type,name:g_name,notSend:data.activeUsers});
